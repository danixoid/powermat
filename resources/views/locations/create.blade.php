...
@section('title') Локации:создать @endsection
...
@section('content')
    ...
    <header id="map">
        <h2><strong>&laquo;Mobile Energy&raquo;</strong> - Создание локацию</h2>
    </header>
            ...
            <div class="container">
                ...
                <form class="form form-horizontal" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="number" class="form-control" name="spots" value="{!! old('spots') !!}" />
                        </div>
                    </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        ymaps.ready(function () {
            ...
            var center = [43.228999, 76.906483];
