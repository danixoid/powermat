...
@section('title') Настройки:создать @endsection
...
@section('content')
    ...
    <header id="news">
        <h2><strong>&laquo;Mobile Energy&raquo;</strong> - Создание настройки</h2>
    </header>
    ...
    <div class="news">
        <div class="content">
            <div class="container">
                ...
                <form class="form form-horizontal" method="POST" action="{!! route('options.store') !!}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <textarea class="form-control" name="val">{!! old('val') !!}</textarea>
                        </div>
                    </div>
                    <div class="form-group">
