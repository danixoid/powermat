...
@section('title') Новости:исправить @endsection
...
@section('content')
    ...
    <header id="news">
        <h2><strong>&laquo;Mobile Energy&raquo;</strong> - Исправление новости</h2>
    </header>
    ...
    <div class="news">
        <div class="content">
            <div class="container">
                ...
                <form class="form form-horizontal" method="POST" action="{!! route('news.update',$news->id) !!}">
                        ...
                        <div class="col-md-6 col-md-offset-3">
                            <div  class="checkbox">
                                <label><input type="checkbox" name="visible" value="1"
                                    @if($news->visible) checked @endif/> Видимость</label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
